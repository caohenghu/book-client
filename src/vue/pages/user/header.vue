<template>
    <div class="header">
        <div class="wrapper-center">
            <div class="nav">
                <ul>
                    <router-link class="transition" to="admin" tag="li">图书管理</router-link>
                    <router-link class="transition active" to="user" tag="li">会员管理</router-link>
                </ul>
            </div>
            <div class="condition">
                <ul>
                ...
                <a class="add btn red" @click="showUserAdd">添加</a>
            </div>
        </div>
    </div>
</template>
